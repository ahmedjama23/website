...
namespace dotnet.Models.Jobs
{
    public class MockJobRepository: IJobRepository
    {
        ...
        public MockJobRepository()
        {
            ...
            _jobList.Add(new Job(1, "The Solution Stack", "Software Developer", "Calgary, AB", tssResp, tssDesc, "February 2019", "Present"));
            ...
            _jobList.Add(new Job(2, "H&R Block", "Digital Product Analyst", "Calgary, AB", hrBlockResp, hrBlockDesc, "September 2016", "February 2019"));
            ...
            _jobList.Add(new Job(3, "Shaw Communications", "Customer Solutions Expert", "Calgary, AB", shawResp, shawDesc, "January 2016", "September 2016"));
            ...
            _jobList.Add(new Job(4, "Ninety Five Noir", "Freelance Web Developer", "Calgary, AB", nfnResp, nfnDesc, "November 2015", "December 2016"));
        }
